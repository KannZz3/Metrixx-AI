...
v4 minimal fix:
- Ensures output parent folders are created before writing JSON/JSONL/CSV/TXT files.
...
def main() -> int:
    ...
    print("=" * 80)
    print("USDA AMS / MARS Step 5 Unified Fetcher LIGHT v4 COMMODITY SPLIT FIXED")
    print("=" * 80)
